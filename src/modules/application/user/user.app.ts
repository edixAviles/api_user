...
class UserAppService extends ApplicationService {
  ...
  async insertUser(userInsert: IUserInsert): Promise<Response<UserDto>> {
    ...
    try {
      if (
        userInsert.isDriver &&
        (!userInsert.licencePhoto || !userInsert.policeRecord)
      ) {
        const error = LocalizeError.getErrorByCode(
          UserErrorCodes.DriverDataNotComplete,
        )
  ...
  async updateUserProfilePhoto(
    userUpdate: IUserUpdateProfilePhoto,
  ...
  async updateDriverLicencePhoto(
  ...
  async updateDriverPoliceRecord(
  ...
  async updateUserPassword(
    userUpdate: IUserUpdatePassword,
